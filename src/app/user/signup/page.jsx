...
const Signup = () => {
  return (
    <div className=' min-h-screen  flex items-center justift-center '>

<div className="flex w-full  max-w-sm  mx-auto overflow-hidden bg-sky-500 border-2 border-slate-100 rounded-lg shadow-2xl shadow-blue-400 lg:max-w-5xl">
  <div
  ...
  <div className="w-full mt-7  px-6 py-8 md:px-8 lg:w-1/2">
    ...
    <p className="pb-3  text-3xl font-sans font-bold text-center text-white ">
      Create Your Account 
    </p>
    {/* <a
      href="#"
