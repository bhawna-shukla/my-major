...
const Service = () => {
  return (
    <div>
      {/* <section className=" z-10 font-serif">
        <div className="flex flex-col md:flex-row items-center max-w-8xl px-6  mx-auto">
          ...
          <div className="w-full md:w-1/2 py-1">
            <img
              src="https://img.freepik.com/free-vector/character-illustration-diy-home-improvement-concept_53876-64634.jpg"
              className="g-image"
            />
          </div>
        </div>
      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
        <div className="max-w-2xl text-center mx-auto">
          ...
          <div className="mt-5 max-w-2xl">
            <h1 className="block font-semibold font-sans text-blue-700 text-2xl md:text-2xl lg:text-6xl">
             <span className='font-[Poppins] text-purple-900'>Transform Your Idea into a Thriving Business with</span> Our Incubator Services
            </h1>
          </div>
          {/* End Title */}
          <div className="mt-5 max-w-3xl">
            <p className="text-lg font-serif text-gray-700">
            These services are tailored to foster growth, innovation, and sustainability while reducing the risks faced by startups
            </p>
          </div>
          {/* Buttons */}
  ...
  {/* End Hero */}
        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          {/* Grid */}
          <div className=" bg-slate-100 border-2 shadow-xl shadow-slate-300 md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
            <div>
              <img
            ...
            <div className="mt-5 sm:mt-10 lg:mt-0">
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-2 md:space-y-4">
                  <h2 className="font-bold font-[Poppins]]text-2xl lg:text-6xl text-pink-600">
                    Planning 
                  </h2>
                  <p className="text-gray-500">
                  Planning is the process of outlining steps, strategies, and actions to achieve a specific goal or objective..
                  </p>
                  <a
              className="py-3 px-4 inline-flex items-center gap-x-2 text-md font-medium rounded-lg border border-transparent bg-pink-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
              href="/user/planning"
            >
              Click Here
              <svg
          ...
          <div className=" bg-slate-100 border-2 shadow-xl shadow-slate-300 md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
            ...
            <div className="mt-5 sm:mt-10 lg:mt-0">
              <div className="space-y-6 sm:space-y-8">
                {/* Title */}
                <div className="space-y-2 md:space-y-4">
                  <h2 className="font-bold font-[Poppins]]text-2xl lg:text-6xl text-orange-600">
                Managing
                  </h2>
                  <p className="text-gray-500">
                  This process is essential for building trust, ensuring client satisfaction, and achieving long-term business success.
                  </p>
                  <a
              className="py-3 px-4 inline-flex items-center gap-x-2 text-md font-medium rounded-lg border border-transparent bg-orange-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
              href="/user/managing"
            >
              Click Here
              <svg
        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          {/* Grid */}
          <div className="bg-slate-100 border-2 shadow-xl md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
            <div>
              <img
                className="rounded-xl"
                src="https://img95.lovepik.com/photo/40105/7217.gif_wh860.gif"
                alt="Features Image"
              />
            </div>
            {/* End Col */}
            <div className="mt-5 sm:mt-10 lg:mt-0">
              <div className="space-y-6 sm:space-y-8">
                {/* Title */}
                <div className="space-y-2 md:space-y-4">
                  <h2 className="font-bold font-[Poppins]]text-2xl lg:text-6xl text-teal-500">
                    Launching
                  </h2>
                  <p className="text-lg font-serif text-gray-600">
                  launching with a client requires careful coordination to ensure that the goals are met, expectations are aligned, and everything runs smoothly.
                  </p>
                  <a
              className="py-3 px-4 inline-flex items-center gap-x-2 text-md font-medium rounded-lg border border-transparent bg-teal-500 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
              href="/user/launching"
            >
              Click Here
              <svg
       ...
       {/* ========== FOOTER ========== */}
       <footer className="  w-full  shadow-2xl shadow-black  bg-violet-600 py-10 px-4 sm:px-6 lg:px-8 ">
          {/* Grid */}
