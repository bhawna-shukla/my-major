...
const About = () => {
  return (
    <div >
      {/* <div className=" mt-12 max-w-sm mx-auto overflow-hidden bg-transparent border-2 rounded-lg shadow-lg shadow-gray-900 lg:max-w-6xl">
    <img
      src="https://img.freepik.com/free-photo/diverse-women-working-together-project-office_9975-23096.jpg"
      alt=""
    ...
    <div className=" mx-auto max-w-7xl px-6 lg:px-8">
      <div className="mx-auto max-w-2xl lg:mx-0">
        <h2 className=" ml-12 underline  text-5xl font-bold font-sans tracking-tight text-purple-900 sm:text-7xl">
          About Us...
        </h2>
        <p className=" mt-8 ml-24 text-pretty text-2xl font-medium text-gray-900 sm:text-xl/8">
        At <span className='text-blue-800 font-semibold'>Bussiness Incubator</span>, we are dedicated to fostering innovation and supporting the next generation of entrepreneurs. Our mission is to provide aspiring startups with the resources, mentorship, and collaborative environment they need to turn their ideas into successful businesses.    </p>
      </div>
