                      ...
                      <li className="hs-accordion" id="users-accordion-sub-1">
                        ...
                        >
                          <ul className="pt-1 space-y-1">
                            <li>
                              <a
                                className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-white rounded-lg hover:bg-white/10 focus:outline-none focus:bg-white/10"
                                href="#"
                              >
                                Link 1
                              </a>
