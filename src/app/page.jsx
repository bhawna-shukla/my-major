...
<>
  ...
  <footer className="  w-full  shadow-2xl shadow-black  bg-violet-700 py-10 px-4 sm:px-6 lg:px-8 ">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
      ...
      <BuildingOfficeIcon className='size-7 text-white flex mb-6'/>
        <a
          className="flex-none p-2  font-[cursive] text-2xl bg-white text-violet-700 focus:outline-none focus:opacity-80"
          href="/"
          aria-label="Brand"
        >
         
          HO_<span className='bg-white text-sky-700'>NUK</span>
        </a>
